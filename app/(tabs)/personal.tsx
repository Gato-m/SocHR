...
export default function Personal() {
    ...
    try {
      ...
      if (error) {
        ...
        if (error.code === 'PGRST301' || error.code === '42P01') {
          console.error('⚠️  Table not found. Make sure you have a "users" table in your Supabase database.');
        } else if (error.message.includes('permission denied')) {
          console.error('🔒 Permission denied. Check your Row Level Security (RLS) policies in Supabase.');
        }
  ...
  }, [getAvatarUrl, handlePhonePress]); // Add dependencies here
